...
const IncomeTypesTable = ({
    ...
    const [sortColumn, setSortColumn] = React.useState("incomeTypeId");
    ...
    const routeChange = (item) =>{ 
        let path = `${INCOME_TYPES_MANAGER_PATH}/${item?.id}`; 
        navigate(path);
    }
...
export default IncomeTypesTable;